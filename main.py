    """
    Cron Helper Yx53gb7i
    ====================
    Productivity CLI tool that automates the task of organiseing common file operations.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Productivity CLI tool that automates the task of organiseing common file operations.")
